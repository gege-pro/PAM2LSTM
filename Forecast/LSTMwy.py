...
# input_layer1 = tf.keras.layers.Masking(mask_value=2000, input_shape=(MaxLen, 3))(input_layer1)
...
# save model
GRU_layer.save('../h5/LSTMwy' + '-' + str(len_pre) + '.h5')
...
#
GRU_layer.load_weights('../h5/LSTMwy' + '-' + str(len_pre) + '.h5')
...
preAndReal.to_csv('../h5/LSTMwy2_P&S.csv')
